...
PACKAGES = {
    ...
    "phl-windows-setup.exe":     ("v1.0.7", "171,885,875", ["Windows 10/11", "x64"]),
    "phl-macos.dmg":             ("v1.0.7", "212,783,388", ["macOS 13.0", "x86_64"]),
    # PLL Windows 自 2026-09-21 起改用 WiX 构建的 MSI（只出安装版，不再提供便携版 exe）
    "phllite-windows-setup.msi": ("v1.2.0", "54,763,520", ["Windows", "x64"]),
    "phllite-macos.dmg":         ("v1.2.0", "38,062,639", ["macOS 11.0", "x86_64"]),
}
BUILD_DATE = "2026-09-12"
#: 2026-09-21 重出过的包 → 它们卡片上的日期比 BUILD_DATE 新
NEWER_DATE = {"phl-windows-setup.exe": "2026-09-21",
              "phl-macos.dmg": "2026-09-21",
              "phllite-windows-setup.msi": "2026-09-21",
              "phllite-macos.dmg": "2026-09-21"}
...
def main():
    ...
    check("8. 每张卡片都有更新日期：4 张 %s + 4 张重出的 2026-09-21" % BUILD_DATE,
          dl.count(BUILD_DATE) == 4 and dl.count("2026-09-21") == 4,
